			...
			case 'product':
				switch($switch_table){
					case 'price':
						...
						break;
					case 'category':
						$query = 'SELECT '.hikashop_table('category').'.'.implode(','.hikashop_table('category').'.',$columns).','.hikashop_table('product_category').'.product_id,'.hikashop_table('category').'.category_id';
						$query .= ' FROM '.hikashop_table('category');
