...
<div class="hika_confirm">
	...
	<input type="hidden" name="cid" value="<?php echo $this->cart_id; ?>"/>
	...
	<div class="hika_confirm_btn">
		<button onclick="hikashop.submitform('customer_save', 'hikashop_form'); window.parent.location.reload();" class="btn"><img src="<?php echo HIKASHOP_IMAGES ?>ok.png" style="vertical-align:middle" alt=""/> <span><?php echo Jtext::_('OK'); ?></span></button>
	</div>
</div>
</form>
