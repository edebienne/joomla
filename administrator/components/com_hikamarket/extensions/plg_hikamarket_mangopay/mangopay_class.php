...
class hikamarketPlg_mangopayClass extends JObject {
	...
	public function saveForm() {
		$formData = JRequest::getVar('mango', array(), '', 'array');
		if(empty($formData))
			return false;
		...
		if(!empty($formData['legalpersontype']) && in_array($formData['legalpersontype'], array('BUSINESS', 'ORGANIZATION')))
	...
	public function addBank() {
		$formData = JRequest::getVar('mangobank', array(), '', 'array');
		if(empty($formData))
			return false;
	...
	public function addDocument() {
		$formData = JRequest::getVar('mangodoc', array(), '', 'array');
		if(empty($formData))
			return false;
	...
	public function doPayout() {
		$formData = JRequest::getVar('payout', array(), '', 'array');
		if(empty($formData))
			return false;
