...
class plgHikashoppaymentMangopay extends hikashopPaymentPlugin
{
	...
	protected function payVendors(&$order) {
		...
		$update_order = new stdClass();
		$update_order->order_id = $order->order_id;
		$update_order->order_payment_params = clone($order->order_payment_params);
		unset($order->order_payment_params->mangopay->walletId);
		$update_order->order_payment_params->mangopay->paid = true;
