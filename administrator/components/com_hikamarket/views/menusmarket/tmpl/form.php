...
<?php if(!HIKASHOP_J16) { ?>
						<tr>
							<td class="key"><?php echo JText::_('HIKA_NAME'); ?></td>
							<td>
...
<?php } else { ?>
						<tr>
							<td class="key"><?php echo JText::_('HIKA_TITLE'); ?></td>
							<td>
...
<?php } ?>
						<tr>
							<td class="key"><?php echo JText::_('HIKA_ALIAS'); ?></td>
							<td>
...
<?php  ?>
						...
						<tr>
							...
							?></td>
							<td><?php
								echo $this->contentType->display('menu[content_type]',@$this->element->content_type, $this->js, true, true);
							?></td>
						</tr>
						<tr>
...
?>
				...
				<fieldset data-block="options" data-block-value="images" class="adminform">
					...
					<table class="admintable table" cellspacing="1" width="100%">
						<tr>
							...
							<td><?php
								...
								echo $this->itemlayoutType->display($this->control.'[div_item_layout_type]', @$this->element->hikamarket_params['div_item_layout_type'], $this->js, '');
							?></td>
						</tr>
						<tr>
...
<?php if(!HIKASHOP_J16){ ?>
	<input type="hidden" name="menu[componentid]" value="<?php echo @$this->element->componentid; ?>" />
<?php }else{ ?>
	<input type="hidden" name="menu[component_id]" value="<?php echo @$this->element->component_id; ?>" />
<?php } ?>
