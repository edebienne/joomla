...
<h3><?php echo JText::_('HIKA_DETAILS'); ?></h3>
<dl class="hikam_options large">
	<dt><?php
		echo JText::_('TYPE_OF_CONTENT');
	?></dt>
	<dd><?php
		echo $this->contentType->display($this->name.'[content_type]', @$this->element['content_type'], $this->js, true, $this->id);
	?></dd>
...
<div class="hkc-xl-4 hkc-lg-6">
<h3><?php echo JText::_('HIKAM_PARAMS_FOR_IMAGES'); ?></h3>
<dl class="hikam_options large">
...
<div class="hkc-xl-4 hkc-lg-6" data-block="content" data-block-value="vendor">
<h3><?php echo JText::_('PARAMS_FOR_VENDORS'); ?></h3>
<dl class="hikam_options large">
...
<div class="hkc-xl-4 hkc-lg-6" data-block="layout" data-block-value="div">
<h3><?php echo JText::_('PARAMS_FOR_DIV'); ?></h3>
<dl class="hikam_options large">
...
<div class="hkc-xl-4 hkc-lg-6" data-block="layout" data-block-value="list">
<h3><?php echo JText::_('PARAMS_FOR_LIST'); ?></h3>
<dl class="hikam_options large">
