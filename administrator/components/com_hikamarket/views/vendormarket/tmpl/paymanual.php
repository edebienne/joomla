...
?>
<fieldset>
	<button class="btn" style="margin:5px;" type="button" onclick="if(window.parent) { window.parent.hikamarket.closeBox(); } return false;"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png"/> <?php echo JText::_('HIKA_CANCEL'); ?></button>
	<div class="toolbar" id="toolbar" style="float: right;">
		<button class="btn" style="margin:5px;" type="button" onclick="submitbutton('paymanual');"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save.png"/> <?php echo JText::_('OK'); ?></button>
	</div>
</fieldset>
