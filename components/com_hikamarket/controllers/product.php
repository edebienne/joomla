...
class productMarketController extends hikamarketController {
	protected $rights = array(
		'display' => array('listing', 'selection', 'useselection', 'getprice', 'gettree', 'findtree', 'upload', 'image', 'file', 'edit_translation', 'file_entry', 'galleryimage', 'cartlink', 'waitingapproval'),
		'add' => array('add'),
