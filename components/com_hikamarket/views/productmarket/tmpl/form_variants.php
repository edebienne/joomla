...
<div>
	<div style="float:right">
		<button class="btn btn-success" onclick="return window.productMgr.addVariants(this, <?php echo (int)$this->product->product_id; ?>);"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/plus.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKAM_ADD_VARIANTS'); ?></button>
	</div>
	<div id="hikamarket_variant_bundle_toolbar" style="display:none;">
		<button class="btn btn-danger" onclick="return window.productMgr.deleteVariants(this, <?php echo (int)$this->product->product_id; ?>);"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_DELETE'); ?></button>
		<button class="btn btn-info" onclick="return window.productMgr.duplicateVariants(this, <?php echo (int)$this->product->product_id; ?>);"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/copy.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKAM_DUPLICATE'); ?></button>
	</div>
...
<?php
	...
	?>	<tr class="row<?php echo $k; ?>" id="hikamarket_product_variant_line_<?php echo $variant->product_id; ?>"> <!--style="cursor:pointer" onclick="return window.productMgr.editVariant(<?php echo $variant->product_id; ?>);">-->
			...
			<td style="text-align:center"><a href="#edit:<?php echo $variant->product_id; ?>" onclick="return window.productMgr.editVariant(<?php echo $variant->product_id; ?>);"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/edit.png" alt="<?php echo JText::_('HIKA_EDIT'); ?>"/></a></td>
<?php
		$cpt = 0;
		foreach($this->product->characteristics as $characteristic) {
			if((int)$characteristic->characteristic_parent_id > 0)
