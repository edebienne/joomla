...
?><table id="hikamarket_product_characteristics_table" class="adminlist table table-striped" style="width:100%">
	<thead>
		<tr>
			<th style="width:1%"></th>
			<th class="title"><?php
			...
			<th style="width:40px;text-align:center">
				<a href="#" onclick="return window.productMgr.newCharacteristic();"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/plus.png" alt="<?php echo JText::_('ADD'); ?>"></a>
			</th>
		</tr>
	</thead>
	<tfoot>
		...
		array(
			...
			'default_text' => 'PLEASE_SELECT'
				...
				<div style="float:right">
					<button onclick="return window.productMgr.addCharacteristic();" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save2.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_SAVE'); ;?></button>
				</div>
				<button onclick="return window.productMgr.cancelNewCharacteristic();" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
...
?>
		<tr class="row<?php echo $k ?>">
			<td class="hikam_column_move"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-14/move.png" alt=""/></td>
			<td><?php
			...
			<td style="text-align:center">
				<a href="#delete" onclick="return window.productMgr.deleteCharacteristic(this, <?php echo (int)$characteristic->characteristic_id; ?>); return false;"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/delete.png" alt="<?php echo JText::_('HIKA_DELETE'); ?>"></a>
...
?>
		<tr id="hikamarket_characteristic_row_template" class="row<?php echo $k ?>" style="display:none;">
			...
			<td>{NAME}</td>
			<td style="text-align:center">
				<a href="#delete" onclick="return window.productMgr.deleteCharacteristic(this, {ID}); return false;"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/delete.png" alt="<?php echo JText::_('HIKA_DELETE'); ?>"></a>
