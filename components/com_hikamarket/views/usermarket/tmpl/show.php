...
<h2><?php echo JText::_('ORDERS'); ?></h2>
	<table class="hikam_listing <?php echo (HIKASHOP_RESPONSIVE)?'table table-bordered table-striped table-hover':'hikam_table'; ?>" style="width:100%">
		<thead>
			<tr>
