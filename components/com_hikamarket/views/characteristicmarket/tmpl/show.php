...
?>
	<div>
		<button onclick="return window.characteristicMgr.addValue(this);" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/plus.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKAM_ADD_VALUE'); ;?></button>
	</div>
<?php
...
<?php } ?>
		...
		<div style="float:right">
			<button onclick="return window.characteristicMgr.createValue();" class="btn btn-success"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save2.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_SAVE'); ;?></button>
		</div>
		<button onclick="return window.characteristicMgr.cancelAddValue();" class="btn btn-danger"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt="" style="vertical-align:middle;"/> <?php echo JText::_('HIKA_CANCEL'); ;?></button>
		<div style="clear:both"></div>
	</div>
<?php
		}
...
?>
	<div id="market_characteristic_value_edit_tpl" style="display:none;">
		<input type="text" size="30" style="min-width:60%" name="{NAME}" id="{INPUT_ID}" value="{VALUE}"/>
		<a href="#save" onclick="return window.characteristicMgr.saveValue(this,{ID});"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save.png" alt=""/><span class="hikam_btn_text"><?php echo JText::_('HIKA_SAVE'); ?></span></a>
		<a href="#cancel" onclick="return window.characteristicMgr.cancelValue(this,{ID});"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt=""/><span class="hikam_btn_text"><?php echo JText::_('HIKA_CANCEL'); ?></span></a>
	</div>
<?php if($this->show_vendor && $this->vendor->vendor_id <= 1) { ?>
