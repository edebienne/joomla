...
?>
	...
	if($this->acl_edit_value && $editable) echo '<a href="#edit" onclick="return window.characteristicMgr.edit(this, '.(int)$characteristic->characteristic_id.');"><img src="'.HIKAMARKET_IMAGES.'icon-16/edit.png" style="vertical-align:top;margin-right:4px;"/>';
...
?>
		<tr class="row<?php echo $k; ?>" id="market_characteristic_tpl" style="display:none;">
			<td class="hikamarket_characteristic_name_value" id="market_characteristic_value_{ID}"><div><?php
				if($this->acl_edit_value) echo '<a href="#edit" onclick="return window.characteristicMgr.edit(this, {ID});"><img src="'.HIKAMARKET_IMAGES.'icon-16/edit.png" style="vertical-align:top;margin-right:4px;"/>';
...
<?php if($this->characteristic_actions) { ?>
			<td class="hikamarket_characteristic_actions_value"><?php
				if($this->characteristic_action_delete)
					echo '<a href="javascript:void(0);" onclick="window.hikashop.deleteRow(\'market_characteristic_{UUID}\'); return false;"><img src="'.HIKAMARKET_IMAGES.'icon-16/delete.png"/></a>';
				else
					echo '-';
			?></td>
<?php } ?>
