...
?>		<div class="hikam_edit"><a href="<?php echo hikamarket::completeLink($update_url, true);?>" onclick="return window.hikamarket.get(this,'hikamarket_order_field_<?php echo $name; ?>');"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/edit.png" alt=""/><span><?php echo JText::_('HIKA_EDIT'); ?></span></a></div>
<?php
	} else {
?>		<div class="hikam_edit">
			<a href="<?php echo hikamarket::completeLink($save_url, true);?>" onclick="return window.hikamarket.form(this,'hikamarket_order_field_<?php echo $name; ?>');"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/save.png" alt=""/><span><?php echo JText::_('HIKA_SAVE'); ?></span></a>
			<a href="<?php echo hikamarket::completeLink($show_url, true);?>" onclick="return window.hikamarket.get(this,'hikamarket_order_field_<?php echo $name; ?>');"><img src="<?php echo HIKAMARKET_IMAGES; ?>icon-16/cancel.png" alt=""/><span><?php echo JText::_('HIKA_CANCEL'); ?></span></a>
		</div>
<?php
	}
}
