...
<?php } ?>
	...
	<div class="hikam_confirm_btn">
		<button onclick="hikamarket.submitform('customer_save', 'hikamarket_form');" class="btn"><img src="<?php echo HIKAMARKET_IMAGES ?>icon-16/save.png" style="vertical-align:middle" alt=""/> <span><?php echo Jtext::_('HIKA_OK'); ?></span></button>
	</div>
</div>
