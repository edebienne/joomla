...
<?php } ?>
<form action="<?php echo hikamarket::completeLink('vendor'); ?>" method="post" name="hikamarket_form" id="hikamarket_form">
	<table class="hikam_filter" style="width:100%">
		<tr>
			<td width="100%">
				...
				<button class="btn" onclick="document.getElementById('hikamarket_vendor_search').value='';this.form.submit();"><?php echo JText::_('RESET');?></button>
			</td>
		</tr>
	</table>
